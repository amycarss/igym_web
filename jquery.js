 ...
 var getPoster = function(){
    ...
    var film = $('#term').val();
     ...
     if(film == ""){
        ...
        $.getJSON("http://api.themoviedb.org/2.1/Movie.search/en/json/a90177a3257c3c1d2699e82c2a9b0f97" + film + "?callback=?", function(json) {
               ...
               //Display the poster and a message announcing the result
                  ...
                  if (json.length != 0){
                    $.getJSON("http://api.themoviedb.org/2.1/Movie.search/en/json/23afca60ebf72f8d88cdcae2c4f31866/" + film + "?callback=?", function(json) {
                        ...
                        a90177a3257c3c1d2699e82c2a9b0f97/goonies?callback=?", function(json) {
